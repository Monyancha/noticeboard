...
(function($, document, window, undefined) {
    ...
    function init(args) {
        ...
        for (callbackName in callbacks) {
            callbackArgs[callbackName] = $.isFunction(args[callbackName]) ? [args[callbackName]] :
                args[callbackName];
            args[callbackName] = [];
        }
...
(function($, document, window, undefined) {
    ...
    $.jmpress("setActive", function(element, eventData) {
        ...
        tf.push(["translate", -(step.x || (step.r * Math.sin(step.phi * Math.PI / 180))), -(step.y || (-step.r * Math.cos(step.phi * Math.PI / 180))), -step.z]);
